...
# Validation 39987 Img: Panseg 1881*5=9405 Pts: Semseg 5976
# Train 158081 Img: Panseg 12296*5=61480 Pts: Semseg 23691

@DATASETS.register_module(name='MwsisWaymoDataset', force=True)
class MwsisWaymoDataset(Custom3DDataset):
    ...
    def __init__(self,
        ...
        self.info_path = info_path  # annotation pth
        self.info_index_path = info_index_path  # index
        self.datainfo_client_args = datainfo_client_args  # data pth
        self.test_mode = test_mode
        self.modality = modality
        self.filter_empty_gt = filter_empty_gt
        self.box_type_3d, self.box_mode_3d = get_box_type(box_type_3d)
        self.load_semseg = load_semseg
        self.load_panseg = load_panseg
        ...
        # load index
        self.data_infos = self.load_local_pkl(self.info_index_path)
    ...
    def get_data_info(self, index):
        ...
        # load infos: get a frame info
        info = self.load_local_infos(self.info_path, self.data_infos[index])
    ...
    def get_ann_info(self, info):
        annos = info['annos']
        annos = self.waymo_to_kitti_class(annos)
    ...
    def evaluate(self, results, **kwargs):
        ...
        if kwargs.get('eval_3d', False):
            out2 =  self.evaluate_semantic_3d(results, **kwargs)
    ...
    def evaluate_mask_3d(self,
        ...
        if osp.exists('./data/waymo/kitti_format/validation_3dmask_infos.json'):
            validation_path = './data/waymo/kitti_format/validation_3dmask_infos.json'
            results_mask_3d_path = '/root/3D/work_dirs/results/mask_3d_preds{}.json'.format(datetime.now().strftime("%m-%d=%H:%M"))
        else:
            raise FileNotFoundError(f"The file '{validation_path}' does not exist.")
