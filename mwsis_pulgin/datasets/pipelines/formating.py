...
class DefaultFormatBundle(object):
    ...
    def __call__(self, results):
        ...
        for key in [
                ...
                'gt_yaw', 'lidar_density', 'roi_points', 'batch_roi_points',
                'points2img', 'points2img_idx', 'fg_points', 'ori_points',
                'pseudo_labels', 'history_labels', 'ccl_labels', 'sam_masks'
        ]:
        ...
        if 'gt_masks' in results:
            ...
            # results['ori_gt_masks'] = DC(results['ori_gt_masks'], cpu_only=True)
